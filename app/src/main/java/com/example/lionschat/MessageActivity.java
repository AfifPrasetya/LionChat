...
import com.example.lionschat.Adapter.MessageAdapter;
import com.example.lionschat.Model.Chat;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, "You can't send empety message", Toast.LENGTH_SHORT).show();
                }
